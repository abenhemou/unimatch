...
# Variables
n_total=100000 # total number of runs
n_runs=1000 # number of runs per script
...
bash_command="python $script_dir/splitting_restricted.py -L $L -n $n_runs -o $output_dir/splits_restricted_$(date +"%Y_%m_%d_%I_%M_%p")_{1}.csv" 
