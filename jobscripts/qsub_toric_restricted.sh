...
bash_command="python $script_dir/toric_restricted_montecarlo.py -L $L -n $n_runs -o $output_dir/toric_restricted_L_$((L))_$(date +"%Y_%m_%d_%I_%M_%p")_{1}.csv" 
