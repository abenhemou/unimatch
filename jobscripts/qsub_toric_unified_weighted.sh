...
B=0.5 # Set B edge weights 
L=12 # Set (color) code distance 
...
bash_command="python $script_dir/toric_unified_weighted_montecarlo.py -L $L -B $B -n $n_runs -o $output_dir/toric_opt_$(date +"%Y_%m_%d_%I_%M_%p")_{1}.csv" 
