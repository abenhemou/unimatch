...
bash_command="python $script_dir/color_unified_weighted_montecarlo.py -L $L -A $A -n $n_runs -o $output_dir/color_unified_weighted_$(date +"%Y_%m_%d_%I_%M_%p")_{1}.csv" 
